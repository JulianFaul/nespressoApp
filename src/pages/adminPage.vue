<template>
	<f7-page style="background-color:#ffffff;">
        <f7-navbar title="Admin" back-link="Back" sliding>
        </f7-navbar>
    ...
    right: 18px;
    top: 50px;">
                <f7-button :href="'/newProduct/'" class="button button-fill color-blue">+ Add New Product</f7-button>
            </span>
        
        <f7-list>
            <f7-list-item :link="'/viewEditProduct/' + product.id" v-for="product in products" v-bind:key="product['.key']" :title="product.name"></f7-list-item>
        </f7-list>
	</f7-block>
